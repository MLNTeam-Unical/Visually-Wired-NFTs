...
edges <- read.csv("/home/user/Progetti/NFT-PrefAttach/graphsV2/COLLLevel-MAX/(2021, 3)/edge_list(0.5).csv", header = TRUE, colClasses = c(NA, NA, "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL"))
...
pdf("/home/user/Progetti/NFT-PrefAttach/scripts/fitting_ccdf_in_MAX(2021, 3).pdf", width = 10, height = 10)
