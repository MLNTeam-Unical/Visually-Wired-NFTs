...
# Caricamento dataset
nft_data <- read.csv("/home/user/Progetti/NFT-PrefAttach/graphsV2/COLLLevel-MIN/(2021, 3)/edge_list(0.5).csv", header = TRUE, colClasses = c(NA, NA, "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL"))

# Generazione grafi
nft_graph <- graph_from_data_frame(nft_data, directed = TRUE)

# Calcolo statistiche
nft_graph_stats_2021_min <- statistiche(nft_graph, output = "nft_topology_min(2021, 3).csv")